...
#화면 전환없이 Javascript를 통해 호출되는 뷰
class OrderCreateAjaxView(View):
    print("views : OrderCreateAjaxView가 실행되었습니다.")
...
class OrderImpAjaxView(View):
    print("view.line124 OrderImpAjaxView가 실행되었습니다.")
    def post(self, request, *args, **kwargs):
        ...
        amount = request.POST.get('amount')
        print("View136, OrderImpAjaxView에서 amount", amount)
